...
public class Category {
	...
	
	{
		...
		driver.findElement(By.xpath("//*[@href=\"/profile?user=category\"]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//span[text()='Bands']")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//span[text()='Dancer']")).click();
